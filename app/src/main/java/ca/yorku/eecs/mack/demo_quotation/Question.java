...
public class Question
{
	 ...
	 *
	 * Sends the location of the correct answers to the QuizActivity where it can be put
	 * into an array to gather them there (to take into account the possibility of having
	 * multiple questions in the quiz)
	 */
	public int getCorrectAnswer(){
		return answerArrayCorrectIdx;
	}
